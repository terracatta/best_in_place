...
BestInPlaceEditor.forms = {
    ...
    activateForm : function() {
      ...
      if(this.okButton) {
        output.append(
          ...
          .attr('type', 'submit')
          .attr('class', 'btn btn-primary save-button')
      ...
      if(this.cancelButton) {
        output.append(
          $(document.createElement('input'))
          .attr('type', 'button')
          .attr('class', 'btn btn-warning cancel-button')
  ...
  "textarea" : {
    activateForm : function() {
      ...
      if(this.okButton) {
        output.append(
          $(document.createElement('input'))
          .attr('type', 'submit')
          .attr('class', 'btn btn-small btn-save')
          .attr('value', this.okButton)
        );
      }
      if(this.cancelButton) {
        output.append(
          $(document.createElement('input'))
          .attr('type', 'button')
          .attr('class', 'btn btn-small btn-cancel')
          .attr('value', this.cancelButton)
        )
      }
    ...
    keyupHandler : function(event) {
      // Uncomment if you think this should abort on esc.
      // if (event.keyCode == 27) {
      //   event.data.editor.abortIfConfirm();
      // }
    }
